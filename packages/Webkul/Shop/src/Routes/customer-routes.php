...
use Webkul\Shop\Http\Controllers\Customer\GoogleController;
use Webkul\Shop\Http\Controllers\Customer\OtpController;
...
Route::prefix('customer')->group(function () {
    ...
    Route::controller(GoogleController::class)->prefix('auth/google')->group(function () {
        Route::get('redirect', 'redirect')->name('shop.customer.google.redirect');

        Route::get('callback', 'callback')->name('shop.customer.google.callback');
    });
