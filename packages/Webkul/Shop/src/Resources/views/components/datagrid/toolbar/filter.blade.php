        ...
        >
            ...
            <template v-else>
                ...
                >
                    <x-slot:toggle>
                        <div
                            class="flex w-full max-w-[200px] cursor-pointer items-center justify-between gap-4 rounded-lg border border-white/10 bg-white/[0.02] py-2 text-sm transition-all hover:border-white/25 focus:border-uf-accent max-md:w-fit ltr:pl-3 ltr:pr-4 max-md:ltr:pl-2.5 max-md:ltr:pr-2.5 rtl:pl-4 rtl:pr-3 max-md:rtl:pl-2.5 max-md:rtl:pr-2.5"
                    ...
                    <x-slot:header class="border-b border-white/10 !px-4">
                                    ...
                                    <template v-if="column.filterable_type === 'dropdown'">
                                        ...
                                        <div class="mb-2 mt-1.5">
                                            <x-shop::dropdown>
                                                <x-slot:toggle>
                                                    <button
                                                        type="button"
                                                        class="flex w-full cursor-pointer items-center justify-between gap-4 rounded-lg border border-white/10 bg-white/[0.02] py-2 text-sm transition-all hover:border-white/25 focus:border-uf-accent max-md:w-full max-md:!py-1.5 ltr:pl-4 ltr:pr-3 max-md:ltr:pl-2.5 max-md:ltr:pr-2.5 rtl:pl-3 rtl:pr-4 max-md:rtl:pl-2.5 max-md:rtl:pr-2.5"
                                                    >
                                        ...
                                        <div class="mb-4 flex flex-wrap gap-2">
                                            ...
                                            <template v-if="column.allow_multiple_values">
                                                <p
                                                    class="flex items-center rounded bg-white/10 px-2 py-1 font-semibold text-white"
                                ...
                                <template v-else-if="column.type === 'date'">
                                    ...
                                    <template v-if="column.filterable_type === 'date_range'">
                                        ...
                                        <div class="mt-4 grid grid-cols-2 gap-1.5 max-sm:my-2">
                                            <p
                                                class="cursor-pointer rounded-md border border-white/10 px-2 py-1.5 text-center font-medium leading-6 text-zinc-400 max-md:text-sm max-sm:font-normal"
                                                v-for="option in column.filterable_options"
                                                v-text="option.label"
                                                @click="addFilter(
                                                    $event,
                                            ...
                                            <x-shop::flat-picker.date ::allow-input="false">
                                                <input
                                                    ...
                                                    value=""
                                                    class="flex min-h-10 w-full rounded-md border border-white/10 px-3 py-2 text-sm text-zinc-400 transition-all hover:border-white/25 max-sm:py-1.5"
                                        ...
                                        <div class="my-4 grid grid-cols-2 gap-1.5">
                                            ...
                                            <x-shop::flat-picker.datetime ::allow-input="false">
                                                <input
                                                    ...
                                                    :name="`${column.index}[from]`"
                                                    value=""
                                                    class="flex min-h-10 w-full rounded-md border border-white/10 px-3 py-2 text-sm text-zinc-400 transition-all hover:border-white/25"
                                                    :placeholder="column.label"
                                                    :ref="`${column.index}[from]`"
                                                    @change="addFilter(
                                                        $event,
                                ...
                                <template v-else>
                                    ...
                                    <template v-else>
                                        ...
                                        <div class="mb-2 mt-1.5 grid">
                                            <input
                                                type="text"
                                                class="w-full rounded-lg border px-3 py-2 text-sm text-zinc-400 transition-all hover:border-white/25 focus:border-uf-accent max-sm:mb-0"
                                                :name="column.index"
                                                :placeholder="column.label"
