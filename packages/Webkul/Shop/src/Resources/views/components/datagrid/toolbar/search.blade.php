                    ...
                    <div class="flex max-w-[445px] items-center max-md:w-full max-md:max-w-[250px]">
                        <div class="relative w-full">
                            <input
                                ...
                                class="rounded-lg border border-white/10 bg-white/[0.02] px-3 py-2 text-base text-zinc-400 transition-all hover:border-white/25 focus:border-uf-accent max-md:max-w-[250px] max-md:py-2 max-sm:py-1.5 ltr:pr-8 rtl:pl-8"
