<!-- SEO Meta Content -->
@push('meta')
    <meta name="description" content="@lang('shop::app.customers.signup-form.otp-verify-page-title')"/>
    <meta name="keywords" content="@lang('shop::app.customers.signup-form.otp-verify-page-title')"/>
@endPush
...
>
    <!-- Page Title -->
    <x-slot:title>
        @lang('shop::app.customers.signup-form.otp-verify-page-title')
    </x-slot>
    ...
    <div class="container mt-20 max-1180:px-5 max-md:mt-12">
        ...
        <div class="m-auto w-full max-w-[870px] rounded-xl border border-zinc-200 p-16 px-[90px] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0">
            ...
            <p class="mt-4 text-xl text-zinc-500 max-sm:mt-0 max-sm:text-sm">
                @lang('shop::app.customers.signup-form.otp-verify-subtitle')
            </p>
            ...
            <div class="mt-14 rounded max-sm:mt-8">
                <x-shop::form :action="route('shop.customers.register.verify.phone.store')">
                    ...
                    <div class="mt-8 flex flex-wrap items-center gap-9 max-sm:justify-center max-sm:gap-5 max-sm:text-center">
                        <button
                            ...
                            type="submit"
                        >
                            @lang('shop::app.customers.signup-form.otp-verify-button')
                        </button>
                    </div>
                </x-shop::form>
            </div>
            ...
            <div class="mt-6 text-center">
                ...
                <form action="{{ route('shop.customers.register.resend.phone.otp') }}" method="POST" class="inline">
                    @csrf
                    <button
                        type="submit"
            ...
            <div class="mt-4 text-center">
                ...
                >
                    @lang('shop::app.customers.signup-form.back-to-register')
                </a>
            </div>
        </div>
