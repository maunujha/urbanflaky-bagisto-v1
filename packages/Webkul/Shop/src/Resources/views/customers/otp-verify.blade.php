...
>
    ...
    <div class="container mt-20 max-1180:px-5 max-md:mt-12">
        ...
        <!-- Form Container -->
        <div class="m-auto w-full max-w-[870px] rounded-xl border border-white/10 p-16 px-[90px] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0">
            ...
            <div class="mt-6 text-center">
                ...
                <form action="{{ route('shop.customer.otp.resend') }}" method="POST" class="inline">
                    ...
                    <button
                        type="submit"
                        class="mt-1 cursor-pointer text-sm font-medium text-uf-accent hover:underline"
                    >
