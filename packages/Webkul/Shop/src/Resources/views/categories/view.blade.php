...
<x-shop::layouts :has-custom-seo="true">
    ...
    @pushOnce('scripts')
        ...
        >
            {{-- max-md bottom padding keeps the last row / load-more clear of the fixed filter bar --}}
            <div class="container px-[60px] max-lg:px-8 max-md:px-4 max-md:pb-20">
                <div class="flex items-start gap-10 max-lg:gap-5 md:mt-10">
                    ...
                    <div class="flex-1">
                        ...
                        <!-- Load More Button -->
                        <button
                            class="secondary-button mx-auto mt-14 block w-max rounded-2xl px-11 py-3 text-center text-base max-md:rounded-lg max-sm:mt-6 max-sm:w-full max-sm:px-6 max-sm:py-3.5 max-sm:text-sm"
                        ...
                        <button
                            ...
                            class="secondary-button mx-auto mt-14 block w-max rounded-2xl px-[74.5px] py-3.5 text-center text-base max-md:rounded-lg max-md:py-3 max-sm:mt-6 max-sm:w-full max-sm:px-[50.8px] max-sm:py-3.5"
                        >
                            <!-- Spinner -->
                            <img
