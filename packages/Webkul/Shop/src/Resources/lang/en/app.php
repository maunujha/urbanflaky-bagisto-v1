...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Copyright 2010 - :current_year, Gabha Enterprise (Registered in India). All rights reserved.',
        ...
        'otp' => [
            ...
            'didnt-receive'       => "Didn't receive the OTP?",
            'enter-otp'           => 'Enter OTP',
            'invalid-otp'         => 'Invalid OTP. Please try again.',
            'login-with-otp'      => 'Login with OTP',
            'no-account'          => 'No account found with this phone number.',
            'or'                  => 'OR',
            ...
            'resent-success'      => 'OTP resent successfully.',
            'send-failed'         => 'Failed to send OTP. Please try again.',
            'send-otp'            => 'Send OTP',
            'sent-success'        => 'OTP sent successfully to your mobile number.',
            'verify-button'       => 'Verify & Login',
            'verify-page-subtitle' => 'Enter the 6-digit OTP sent to your registered mobile number.',
            'verify-page-title'   => 'Verify OTP',
        ],
        ...
        'signup-form' => [
            ...
            'last-name'             => 'Last Name',
            'otp-sent'              => 'OTP sent to your mobile number. Please verify to complete registration.',
            'otp-verify-button'     => 'Verify & Create Account',
            'otp-verify-page-title' => 'Verify Your Mobile Number',
            'otp-verify-subtitle'   => 'Enter the 4-digit OTP sent to your registered mobile number to complete account creation.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text' => '© Copyright 2010 - :current_year, Gabha Enterprise (Registered in India). All rights reserved.',
                'locale' => 'Locale',
    ...
    'products' => [
        ...
        'view' => [
            ...
            'made-on-demand' => [
                ...
                'body' => 'Produced only after you order, so nothing is overstocked and every piece ships fresh. As each item is made for you, returns or exchanges apply only if it arrives damaged, defective, or incorrect.',
            ],
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'index' => [
                ...
                'made-on-demand' => [
                    'title' => 'Made on Demand',
                    'info' => 'This item is produced after your order is placed and is non-returnable except if it arrives damaged, defective, or incorrect.',
                ],
    ...
    'home' => [
        ...
        'index' => [
            ...
            'offer' => 'Get UPTO 20% OFF on your 1st order SHOP NOW test',
    ...
    'rma' => [
        'customer' => [
            'delivered' => 'Delivered',
            'menu-name' => 'RMA',
            'offer' => 'Get UPTO 20% OFF on your 1st order',
            'rma-qty' => 'RMA Qty',
            'shop-now' => 'SHOP NOW',
