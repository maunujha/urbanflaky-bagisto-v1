...
return [
    ...
    [
        ...
        'fields' => [
            [
                ...
                'type' => 'text',
                'default' => 'Get UPTO 20% OFF on your 1st order',
                'validation' => 'max:100',
            ], [
    ...
    [
        'key' => 'marketing',
        'name' => 'admin::app.configuration.index.marketing.title',
        'info' => 'admin::app.configuration.index.marketing.info',
        'sort' => 8,
    ], [
        'key' => 'marketing.exit_intent_popup',
        'name' => 'admin::app.configuration.index.marketing.exit-intent-popup.title',
        'info' => 'admin::app.configuration.index.marketing.exit-intent-popup.info',
        'icon' => 'settings/checkout.svg',
        'sort' => 1,
    ], [
        'key' => 'marketing.exit_intent_popup.settings',
        'name' => 'admin::app.configuration.index.marketing.exit-intent-popup.settings.title',
        'info' => 'admin::app.configuration.index.marketing.exit-intent-popup.settings.info',
        'sort' => 1,
        'fields' => [
            [
                'name' => 'enabled',
                'title' => 'admin::app.configuration.index.marketing.exit-intent-popup.settings.enabled',
                'type' => 'boolean',
                'channel_based' => true,
                'locale_based' => true,
            ], [
                'name' => 'title',
                'title' => 'admin::app.configuration.index.marketing.exit-intent-popup.settings.popup-title',
                'type' => 'text',
                ...
                'name' => 'description',
                'title' => 'admin::app.configuration.index.marketing.exit-intent-popup.settings.popup-description',
                'type' => 'textarea',
                'default' => 'Discover premium oversized streetwear crafted for those who prefer a darker, minimalist aesthetic.',
                'validation' => 'max:300',
                'depends' => 'enabled:true',
                'channel_based' => true,
                'locale_based' => true,
                ...
                'name' => 'coupon_code',
                'title' => 'admin::app.configuration.index.marketing.exit-intent-popup.settings.coupon-code',
                'type' => 'text',
                'default' => 'WELCOME10',
                'validation' => 'max:50',
                'depends' => 'enabled:true',
                ...
                'title' => 'admin::app.configuration.index.marketing.exit-intent-popup.settings.discount-percentage',
                'type' => 'text',
                'default' => 10,
                ...
                'name' => 'cta_text',
                'title' => 'admin::app.configuration.index.marketing.exit-intent-popup.settings.cta-text',
                'type' => 'text',
                ...
                'name' => 'desktop_image',
                'title' => 'admin::app.configuration.index.marketing.exit-intent-popup.settings.desktop-image',
                'type' => 'image',
                'validation' => 'mimes:bmp,jpeg,jpg,png,webp',
                'depends' => 'enabled:true',
                'channel_based' => true,
                ...
                'name' => 'mobile_image',
                'title' => 'admin::app.configuration.index.marketing.exit-intent-popup.settings.mobile-image',
                'type' => 'image',
                'validation' => 'mimes:bmp,jpeg,jpg,png,webp',
                'depends' => 'enabled:true',
                'channel_based' => true,
                ...
                'name' => 'frequency_days',
                'title' => 'admin::app.configuration.index.marketing.exit-intent-popup.settings.frequency-days',
                'type' => 'text',
                'default' => 7,
