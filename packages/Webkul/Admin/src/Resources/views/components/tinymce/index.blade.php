            ...
            methods: {
                init() {
                    ...
                    tinyMCEHelper.initTinyMCE({
                        ...
                        /* Preserve hand-written rich HTML (div wrappers, inline styles, flex/grid
                           layouts) pasted via the code view — TinyMCE's default schema strips
                           <div>s and much inline styling on save, which broke CMS page layouts. */
                        valid_elements: '*[*]',
                        extended_valid_elements: '*[*]',
                        valid_children: '+body[style],+a[div|p|h1|h2|h3|h4|h5|h6|ul|ol|li|span|img]',
                        verify_html: false,
                        cleanup: false,
