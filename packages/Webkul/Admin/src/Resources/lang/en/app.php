        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'video-banner' => [
                    ...
                    'description' => 'Full-width autoplay video hero that links to a product or category.',
                    'link-type' => 'Link Type',
                    'logo' => 'Logo (overlay)',
                    'mobile-video' => 'Mobile Video (optional)',
                    'poster' => 'Poster Image (optional)',
                    'poster-hint' => 'Shown before the video loads and while it is out of view — prevents layout shift.',
                    'product' => 'Product',
                    'select-category' => 'Select Category',
                    'select-product' => 'Select Product',
                    'show-price' => 'Show product price on banner',
                    'title' => 'Video Banner',
                    'video' => 'Desktop Video',
                    'video-hint' => 'MP4 or WebM, recommended under 50 MB for fast loading.',
                ],
            ...
            'catalog' => [
                ...
                'products' => [
                    ...
                    'search' => [
                        ...
                        'trending-limit-info' => 'Number of trending keywords to display (1–20). Default is 8.',
                        'autocomplete' => 'Enable Autocomplete Suggestions',
                        'autocomplete-info' => 'Show instant product suggestions as customers type in the search bar.',
                        'autocomplete-limit' => 'Autocomplete Suggestions Limit',
                        'autocomplete-limit-info' => 'Maximum number of product suggestions to show (1–20). Default is 8.',
