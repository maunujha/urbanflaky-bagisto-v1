{{--
    Shared variant-search + line-items Vue component (`v-purchase-items`).
    Used by both the "Create Purchase" and "Add Items" forms so the picker
    UI isn't duplicated across the two flows.
--}}
@pushOnce('scripts')
    <script
